...
int main()
{
    ...
    */
    load_texture(texture0, "transparent.png", GL_RGBA);
    load_texture(texture1, "grass_2.png", GL_RGBA);
    load_texture(texture2, "brickwall_1.jpg", GL_RGB);
    load_texture(texture3, "wallside1.png", GL_RGBA);
    load_texture(texture4, "road1.png", GL_RGBA);
    ...
    load_texture(texture10, "leather2.png", GL_RGBA);
    load_texture(texture8, "ballprint.png", GL_RGBA);
    load_texture(garden2, "flower1.png", GL_RGBA);
    load_texture(garden1, "flower2.png", GL_RGBA);
    load_texture(whiteflower, "white.png", GL_RGBA);
    load_texture(shoptex, "shop.png", GL_RGBA);
...
// Function to draw a tree using Bézier curves
void drawRealisticTree(Shader& shader, glm::mat4 modelMatrix, unsigned int trunkVAO, unsigned int canopyVAO, std::vector<int>& trunkIndices, std::vector<int>& canopyIndices) {
    shader.use();
